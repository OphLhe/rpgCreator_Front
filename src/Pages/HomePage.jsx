    ...
    return ( 
        ...
        <header>
            ...
            <div className='headerText'>
                <span>
                    LoreCrafters vous permet de créer vos propres histoires, votre propre lore à destination du jeu de rôle. Création d’histoires, de personnages,de PNJ etc...
                </span>
            </div>
        </header>
        ...
        <main className='genreChoice'>
            ...
            <div className='genreBanner'>
                <div className='genreCard'>
                    {genres.map((g) => (
                        <GenreCard key={g.genreName} genreName={g.genreName}/>
                    ))}
                </div>
            </div>
        </main>
